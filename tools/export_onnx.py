...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default='./config/nanodet-g.yml', help='config file path')
    parser.add_argument('--weights_file', type=str, default='rmcv.ckpt', help='weights file path')
    parser.add_argument('--output_file', type=str, default='rmcv-c.onnx', help='onnx file path')
    parser.add_argument('--img_size', nargs='+', type=int, default=[416, 416], help='image size')
